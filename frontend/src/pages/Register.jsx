...
const Register = () => {
 ...
 return (
 <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-secondary to-background    py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
 ...
 <div className="glass-panel p-8 sm:p-10 rounded-2xl w-full max-w-xl z-10 transition-all duration-300 border border-border ">
 <div className="text-center mb-8">
 <div className="flex justify-center mb-4 text-primary">
 <FaUserPlus size={48} />
 </div>
 <h1 className="text-2xl sm:text-3xl font-bold text-text  tracking-tight">Public Analyst Registration</h1>
 <p className="text-muted  mt-2 text-sm">Create an account to securely capture and analyze weapon forensic evidence.</p>
 </div>
 ...
 <div>
 <label className="block text-xs font-semibold text-text  mb-1 flex items-center"><FaUser className="mr-1 text-muted" /> Full Legal Name</label>
 ...
 <div>
 <label className="block text-xs font-semibold text-text  mb-1 flex items-center"><FaIdBadge className="mr-1 text-muted" /> ID Proof Reference</label>
 ...
 <div>
 <label className="block text-xs font-semibold text-text  mb-1 flex items-center"><FaEnvelope className="mr-1 text-muted" /> Email Address</label>
 ...
 <div>
 <label className="block text-xs font-semibold text-text  mb-1 flex items-center"><FaPhone className="mr-1 text-muted" /> Phone Number</label>
 ...
 <label className="block text-xs font-semibold text-text  mb-1 flex items-center"><FaUser className="mr-1 text-muted" /> Desired Username</label>
 ...
 <div>
 <label className="block text-xs font-semibold text-text  mb-1 flex items-center"><FaLock className="mr-1 text-muted" /> Password</label>
 ...
 <div>
 <label className="block text-xs font-semibold text-text  mb-1 flex items-center"><FaLock className="mr-1 text-muted" /> Confirm Password</label>
 ...
 <div className="pt-4">
 <p className="text-xs font-semibold text-text  mb-2">Biometric Setup (Recommended)</p>
 {faceData ? (
 <div className="w-full py-3 px-4 rounded-lg bg-green-50  border border-green-200  text-green-700  font-medium flex items-center justify-center">
 ...
 className="w-full py-3 px-4 rounded-lg text-text  font-semibold bg-secondary  hover:bg-gray-200  border border-border  flex items-center justify-center transition-all shadow-sm"
 >
